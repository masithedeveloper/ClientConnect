package com.clientconnect.controller;

import com.clientconnect.model.LoginInfo;
...
import com.clientconnect.model.User;
...
public class UserController {
    ...
    //----------------------------------------------------------------------------------------------------------
    public UserController(EmployeeService employeeService, UsersService usersService) { // where the hell do these come from, I answer this over the weekend 
        this.employeeService = employeeService;
        this.usersService = usersService;
    }
    //----------------------------------------------------------------------------------------------------------    
    @RequestMapping(path="/user/login", method = RequestMethod.POST)
    public ResponseEntity<User>  userLogin(@RequestBody LoginInfo loginInfo){ // remove this to the LoginController 
        return new ResponseEntity<User>( new User(usersService.getUserByEmail(loginInfo.getEmail())), HttpStatus.OK);
    }
    //----------------------------------------------------------------------------------------------------------
